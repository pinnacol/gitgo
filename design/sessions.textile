...
Gitgo::Repo -- for document CRUD, and wrapping of git functionality
Gitgo::Index -- to manage and query the index (repo.index)
Gitgo::Index::Io -- to read/write specific index entries
